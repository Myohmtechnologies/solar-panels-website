...
export const hautesAlpes: Department = {
  name: "Hautes-Alpes",
  code: "05",
  coverImage: {
  ...
  cities: {
    gap: {
      ...
      reviews: [
        {
          author: "Laurent M.",
          rating: 5,
          comment: "Installation parfaite malgré les conditions montagnardes. Équipe très professionnelle !",
          date: "2023-12-10",
        ...
        },
        {
          author: "Marie P.",
          rating: 5,
          comment: "Excellent service et rendement optimal même en hiver.",
          date: "2023-11-15",
          location: "Quartier de la Cathédrale"
        }
      ],
      recentInstallations: [
        {
          title: "Installation résidentielle à Gap",
          description: "Installation de 12 panneaux solaires sur une villa familiale",
          date: "2023-12-14",
          power: "6 kWc",
          location: "Quartier de la Pépinière",
          details: [
      ...
      seo: {
        title: "Gap : installation solaire pour particuliers et professionnels",
        metaDescription: "Installation solaire à Gap. Profitez d'un ensoleillement exceptionnel en altitude pour optimiser votre production d'énergie.",
        keywords: ["installation solaire", "Gap", "énergie renouvelable", "montagne"],
        images: [
          {
            url: "/images/cities/gap-solar.jpg",
            width: 800,
            height: 600,
