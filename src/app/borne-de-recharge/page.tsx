          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                icon: ShieldCheckIcon,
                title: "Certification IRVE",
                description: "Nos installateurs sont certifiés pour l'installation de bornes de recharge"
              },
              {
            ...
            {[
              {
                ...
                description: "Évaluation gratuite de vos besoins et configuration électrique"
              },
              {
                number: "02",
