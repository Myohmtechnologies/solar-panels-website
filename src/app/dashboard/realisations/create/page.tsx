  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const realisationData = {
        ...
        specifications: {
          puissance: parseFloat(formData.get('puissance') as string) || 0,
          surface: parseFloat(formData.get('surface') as string) || 0,
          orientation: formData.get('orientation') as string || '',
          pannels: Math.ceil((parseFloat(formData.get('puissance') as string) || 0) / 0.4), // Panneaux de 400Wc
          economie: Math.round((parseFloat(formData.get('puissance') as string) || 0) * 1200 * 0.2) // Calcul des économies
        }
      };
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
            <div>
              ...
              <input
                ...
                name="title"
                id="title"
                defaultValue="installation de panneaux solaires RGE a Oraison"
                required
            ...
            <div className="sm:col-span-2">
              ...
              <textarea
                ...
                id="description"
                rows={3}
                defaultValue="Cette installation solaire est conçue pour optimiser la production d'énergie"
                required
                className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-6C8D2F focus:ring-6C8D2F sm:text-sm"
              />
            </div>
