...
export const alpesMaritimes: Department = {
  name: "Alpes-Maritimes",
  code: "06",
  coverImage: {
    url: "/images/departments/alpes-maritimes-cover.jpg",
    alt: "Côte d'Azur et montagnes des Alpes-Maritimes avec installations solaires",
  },
  cities: {
    "nice": {
      name: "Nice",
      ...
      keyPoints: [
        "Première ville des Alpes-Maritimes",
      ...
      seo: {
        title: "Installation Panneaux Solaires à Nice (06) | Devis Gratuit",
        metaDescription: "Installation de panneaux solaires à Nice. Profitez du climat méditerranéen pour optimiser votre production d'énergie solaire.",
        keywords: ["panneaux solaires Nice", "installation solaire 06", "photovoltaïque Nice"],
        images: [
          {
            url: "https://example.com/nice-solaire.jpg",
            width: 800,
            height: 600,
            alt: "Installation solaire à Nice"
          }
        ]
      },
      ...
      reviews: [
        {
          ...
          rating: 5,
          date: "2023-10-20",
          comment: "Installation de qualité, équipe très professionnelle. Parfait suivi du projet.",
          location: "Cannes"
        }
      ],
      seo: {
        title: "Installation Panneaux Solaires à Cannes (06) | Devis Gratuit",
        metaDescription: "Installation de panneaux solaires à Cannes. Profitez d'un service premium et d'une expertise locale reconnue.",
        keywords: ["panneaux solaires Cannes", "installation solaire 06", "photovoltaïque Cannes"],
        images: [
          {
            url: "https://example.com/cannes-solaire.jpg",
            width: 800,
            height: 600,
            alt: "Installation solaire à Cannes"
          }
        ]
      },
      solarInstallation: defaultSolarInstallation
    ...
    "grasse": {
      ...
      keyPoints: [
        "Ville en hauteur bien exposée",
        "Expertise locale disponible",
        "Solutions adaptées au territoire",
        "Accompagnement personnalisé"
      ],
      reviews: [
        {
          ...
          rating: 5,
          date: "2023-11-10",
          comment: "Excellente installation, équipe à l'écoute et professionnelle.",
          location: "Grasse"
        }
      ],
      seo: {
        title: "Installation Panneaux Solaires à Grasse (06) | Devis",
        metaDescription: "Installation de panneaux solaires à Grasse. Profitez d'une exposition optimale pour votre production solaire.",
        keywords: ["panneaux solaires Grasse", "installation solaire 06", "photovoltaïque Grasse"],
        images: [
          {
            url: "https://example.com/grasse-solaire.jpg",
            width: 800,
            height: 600,
            alt: "Installation solaire à Grasse"
          }
        ]
      },
      solarInstallation: defaultSolarInstallation
