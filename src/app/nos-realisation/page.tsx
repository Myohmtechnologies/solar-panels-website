                      ...
                      <div className="p-6">
                        ...
                        <div className="flex items-center justify-between mt-4 pt-4 border-t border-gray-100">
                          <Link
                            ...
                            className="inline-flex items-center text-sm font-semibold text-gray-900 group/link"
                          >
                            Voir le projet
                            <ArrowRightIcon className="h-4 w-4 ml-2 transform group-hover/link:translate-x-1 transition-transform" />
                          </Link>
                        </div>
                      </div>
                    </motion.article>
