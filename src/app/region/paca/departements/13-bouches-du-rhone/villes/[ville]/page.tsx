...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return generateCityMetadata({
    ...
    description: `Installation de panneaux solaires à ${cityData.name}. Profitez d'une expertise locale et d'un service personnalisé pour votre transition énergétique dans les Bouches-du-Rhône.`,
    keywords: [
