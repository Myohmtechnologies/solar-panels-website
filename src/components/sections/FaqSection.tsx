...
const faqs = [
  ...
  },
  {
    ...
    answer: "Le rendement moyen des panneaux photovoltaïques modernes se situe entre 20% et 23%. En région PACA, grâce à l'excellent ensoleillement, un panneau de 1kWc peut produire jusqu'à 1 400 kWh par an. Les dernières technologies de panneaux monocristallins offrent les meilleurs rendements du marché."
  },
  {
  ...
  },
  {
    ...
    answer: "Les panneaux photovoltaïques produisent de l'électricité à partir de la lumière solaire, tandis que les panneaux thermiques chauffent un fluide pour produire de l'eau chaude. Les photovoltaïques sont plus polyvalents car ils permettent d'alimenter tous vos appareils électriques et de revendre le surplus, alors que les thermiques ne servent qu'au chauffage de l'eau."
  },
  {
    question: "Quels sont les produits qui composent les installations solaires photovoltaïques ?",
    answer: "Une installation photovoltaïque complète comprend : les panneaux solaires, un onduleur pour convertir le courant continu en alternatif, un système de fixation adapté à votre toit, un compteur de production, un coffret de protection électrique, et éventuellement des batteries de stockage pour l'autoconsommation. Tous nos composants sont certifiés et garantis jusqu'à 25 ans."
  },
  {
    question: "Puis-je bénéficier d'une exonération d'impôt sur le revenu pour la revente d'électricité ?",
    answer: "Oui, les revenus issus de la vente d'électricité photovoltaïque sont exonérés d'impôt sur le revenu si la puissance de votre installation ne dépasse pas 3kWc. Au-delà, vous pouvez opter pour le régime micro-BIC avec un abattement forfaitaire de 71% sur vos revenus, rendant la fiscalité très avantageuse."
  }
];
